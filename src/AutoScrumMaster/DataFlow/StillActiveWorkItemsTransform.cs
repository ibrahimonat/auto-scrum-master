...
{
    public class StillActiveWorkItemsTransform : ISingletonDependency
    {
        private readonly ILogger<StillActiveWorkItemsTransform> _logger;

        public StillActiveWorkItemsTransform(ILogger<StillActiveWorkItemsTransform> logger)
        {
            _logger = logger;
        }
